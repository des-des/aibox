...
test('branch creator', t => {
  ...
  t.equal(startPos[0], 3, 'banch correctly remembers start x pos');
  t.equal(startPos[1], 6, 'banch correctly remembers start y pos');
  ...
  t.equal(lastPos[1], 8, 'branch.getLastPos gives correct x for end');
